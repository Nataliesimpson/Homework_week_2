...
def test_room_starts_with_0_songs
  assert_equal(0, @room.room_starts_with_0_songs() )
end  

def test_room_starts_with_0_guests
  assert_equal(0, @room.room_starts_with_0_guests() )
end  
